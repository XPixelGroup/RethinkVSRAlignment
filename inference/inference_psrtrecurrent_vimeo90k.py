...
def main():
    ...
    crop_border = 0
    # model
    model_path = 'experiments/5125/net_g_235000.pth'  # noqa E501
    # test data
    test_name = f'Vimeo90K_5125_235k_Interval{interval}-woflip'

    lr_folder = '/data_ssd/swshi/vsr_data/vimeo90k/BIx4'
    gt_folder = '/data_ssd/swshi/vsr_data/vimeo90k/GT'
    save_folder = f'/data_ssd/swshi/SwinVSR_Vimeo/results/{test_name}'
